    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" style="width:100%;height:120px;">${obj.crequest}</textarea></td>
	            <td class="columnTitle">说明：</td>
	            <td class="tableContent"><textarea name="remark" style="width:100%;height:120px;">${obj.remark}</textarea></td>
