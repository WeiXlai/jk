...
public class PoiUtil {
	...
	// 指定图片类型为jpg
	public void setPicture(Workbook wb, HSSFPatriarch patriarch, String pic, int iRow, int iCol) throws IOException {
		// 判断文件是否存在
	...
	// 指定图片类型为jpg
	public void setPicture(Workbook wb, HSSFPatriarch patriarch, String pic, int iRowStart, int iColStart, int iRowStop, int iColStop) throws IOException {
		// 判断文件是否存在
		File imgFile = new File(pic);
		if (imgFile.exists()) {
			// 图片处理
	...
	// 画线
	public void setLine(Workbook wb, HSSFPatriarch patriarch, int iRowStart, int iColStart, int iRowStop, int iColStop) {
